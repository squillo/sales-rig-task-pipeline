...
///
/// ```no_run
/// # use transcript_processor::application::use_cases::manage_task::ManageTaskUseCase;
    ...
    R: crate::application::ports::task_repository_port::TaskRepositoryPort,
{
    ...
    pub fn update_task_status(
        ...
        let filter = crate::application::ports::task_repository_port::TaskFilter::ById(
            task_id.to_string()
        );
    ...
    /// # use transcript_processor::application::use_cases::manage_task::ManageTaskUseCase;
    /// # use transcript_processor::adapters::in_memory_task_adapter::InMemoryTaskAdapter;
    /// # use transcript_processor::application::ports::task_repository_port::TaskSortKey;
    /// let repo = InMemoryTaskAdapter::new();
    /// let use_case = ManageTaskUseCase::new(repo);
    ...
    pub fn get_sorted_tasks(
        &self,
        sort_key: crate::application::ports::task_repository_port::TaskSortKey,
        direction: hexser::ports::repository::Direction,
    ) -> std::result::Result<Vec<crate::domain::task::Task>, std::string::String> {
        let filter = crate::application::ports::task_repository_port::TaskFilter::All;
...
mod tests {
    ...
    fn test_update_task_status() {
        ...
        let filter = crate::application::ports::task_repository_port::TaskFilter::ById(task_id.clone());
