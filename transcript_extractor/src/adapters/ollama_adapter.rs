...
//!
//! Revision History
//! - 2025-11-06T19:01:00Z @AI: Moved to transcript_extractor crate from transcript_processor split.
...
///
/// ```
/// # use transcript_extractor::adapters::ollama_adapter::OllamaTranscriptExtractorAdapter;
...
{{
  ...
  "assigned_to": "Name of person assigned (or null if not specified)",
...
impl crate::ports::transcript_extractor_port::TranscriptExtractorPort
