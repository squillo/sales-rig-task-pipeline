...
///
/// ```
/// # use transcript_extractor::ports::transcript_extractor_port::TranscriptExtractorPort;
/// # use transcript_extractor::domain::transcript_analysis::TranscriptAnalysis;
